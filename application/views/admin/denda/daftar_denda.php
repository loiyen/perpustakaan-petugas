                        ...
                        <div class="col-xxl">
                            <div class="card mb-4">
                                ...
                                <div class="card-header mb-0">
                                    <h6>Filter : </h6>
                                    <a href="<?= site_url('denda') ?>" class="btn btn-warning"> Belum lunas</a>
                                    <a href="<?= site_url('denda/lunas') ?>" class="btn btn-outline-primary"> Lunas</a>
                                </div>
                                <div class="card-body">
                                                ...
                                                ?>
                                                        <tr>
                                                            ...
                                                            <td class="text-center">
                                                                <button type="button" class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#modalCenter<?= $val->id_pengembalian; ?>">
                                                                    Bayar
                                                                </button>
