                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <div class="card">
                                ...
                                <form method="get" action="<?= site_url('riwayat/cariData') ?>">
                                    <div class="float-end">
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="keyword" class="form-control" placeholder="Cari nomor peminjaman / nama siswa..." aria-label="Recipient's username" value="<?php echo $this->input->get('keyword'); ?>" aria-describedby="button-addon2" />
                        ...
                        <!-- <form action="<?= site_url('riwayat/pengurutanData') ?>" method="post">
                            <div class="card-header d-flex align-items-center justify-content-between btn-sm">
                                <label for="defaultSelect" class="form-label">urutkan data : </label>
                                ...
                                <nav aria-label="Page navigation">
                                    <ul class="pagination pagination">
                                        <li class="page-item prev">
                                            <a class="page-link" href="<?= base_url('index.php/riwayat/pengurutanData/' . ($current_page - 1)) ?>"><i class="tf-icon bx bx-chevrons-left"></i></a>
                                        </li>
                                        <?php for ($i = 1; $i <= $total_pages; $i++) : ?>
                                            <li class="page-item <?= $i == $current_page ? 'active' : '' ?>">
                                                <a class="page-link" href="<?= base_url('index.php/riwayat/pengurutanData/' . $i) ?>"><?= $i ?></a>
                                            </li>
                                        <?php endfor; ?>
                                        <li class="page-item next">
                                            <a class="page-link" href="<?= base_url('index.php/riwayat/pengurutanData/' . ($current_page + 1)) ?>"><i class="tf-icon bx bx-chevrons-right"></i></a>
                                        </li>
                                    </ul>
                                </nav>
                            </div>
