                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <div class="card">
                                ...
                                <form method="get" action="<?= site_url('buku/pencarian_buku') ?>">
                                    <div class="float-end">
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="keyword" class="form-control" placeholder="Cari judul / kode buku ..." aria-label="Recipient's username" value="<?php echo $this->input->get('keyword'); ?>" aria-describedby="button-addon2" />
                        ...
                        <div class="card-header d-flex align-items-center justify-content-between">
                            ...
                            <small class="float-end"> <a href="<?= site_url('buku/print_barcode') ?>" class="btn btn-danger btn-sm "><i class='bx bx-printer'></i></a></small>
                        </div>
                                        ...
                                        if (empty($buku)) {
                                            ...
                                            foreach ($buku as $key => $val) :
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <strong><?= $val->judul_buku; ?></strong>
                                                        <div class="mt-2">
                                                            <span>Nomor ISBN :<br><strong><?= $val->isbn; ?></strong></span>
                                                        </div>
                                                    </td>
